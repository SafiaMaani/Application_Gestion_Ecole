<nav class="sidebar close d-flex align-items-center border-top">
    <div class="menu-bar">
        <div class="menu">
            <ul class="menu-links">
                <li class="nav-link">
                    <a href="dashboard">
                        <i class="ic fa-solid fa-chart-line"> </i>
                ...
                <li class="nav-link">
                    <a href="students">
                        <i class="ic fas fa-user-graduate"></i>
                ...
                <li class="nav-link">
                    <a href="parents">
                        <i class="ic fas fa-user-friends"></i>
                        <span class="text nav-text">Parents</span>
                    </a>
                </li>
                <li class="nav-link">
                    <a href="admin">
                        <i class="ic fas fa-users"></i>
